...
public class b extends AsyncTask<Void, Void, a> {
    ...
    protected a doInBackground(Void[] voidArr) {
        ...
        String format = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.a, this.f919c, this.d, this.b, this.e);
