...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), Build.VERSION.SDK_INT >= 23 ? 201326592 : 134217728).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
                    ...
                    if (str != null && str.contains("openbusinesswebview")) {
                        try {
                            ...
                            if (parse != null && "openbusinesswebview".equals(parse.getHost())) {
                                ...
                                String queryParameter2 = parse.getQueryParameter(d.y);
                                if (queryParameter2 != null && queryParameter2.length() > 0) {
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0115a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0115a.f917c = "weixin://registerapp?appid=" + this.appId;
        c0115a.d = j;
        return a.a(this.context, c0115a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0115a c0115a = new a.C0115a();
        c0115a.a = "com.tencent.mm";
        c0115a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0115a.f917c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0115a);
    }
}
