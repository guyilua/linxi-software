...
/* compiled from: TBSResources.java */
...
public class d {
    ...
    public static String c(String str) {
        ...
        while (true) {
            ...
            if (str3.equalsIgnoreCase(strArr[i][0])) {
                str2 = a[i][1];
                break;
            }
            i++;
