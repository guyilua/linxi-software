...
public class m {
    ...
    public float b() {
        ...
        return f != null ? f.floatValue() : com.sigmob.sdk.base.blurkit.c.d;
    }
    ...
    public void d() {
        this.a.invokeMethod(this.b, "com.tencent.tbs.player.TbsMediaPlayerProxy", PointCategory.PLAY, new Class[0], new Object[0]);
    }

    public void e() {
        this.a.invokeMethod(this.b, "com.tencent.tbs.player.TbsMediaPlayerProxy", PointCategory.CLOSE, new Class[0], new Object[0]);
    }
