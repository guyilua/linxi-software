...
public class a {
    ...
    public static final byte[] a = {98, -24, 57, -84, -115, 117, e.O, 121};
    public static final byte[] b = {-25, -101, -115, 1, 47, 7, -27, -59, 18, Byte.MIN_VALUE, 123, 79, -44, 37, 46, 115};

    /* renamed from: c, reason: collision with root package name */
    public static final byte[] f953c = {37, -110, 60, Byte.MAX_VALUE, 42, -27, -17, -110};
    ...
    private static byte[] b(byte[] bArr, byte[] bArr2, int i2) {
        if (bArr.length == 8 && bArr2.length == 8 && (i2 == 1 || i2 == 0)) {
            int[][] iArr = (int[][]) Array.newInstance((Class<?>) int.class, 16, 48);
            int[] a2 = a(bArr);
            int[] a3 = a(bArr2);
            a(a2, iArr);
            return a(a3, i2, iArr);
    ...
    private static void a(int[] iArr, int i2, int i3, int[][] iArr2) {
        ...
        while (i6 < i7) {
            for (int i8 = 0; i8 < 6; i8++) {
                iArr8[i6][i8] = iArr7[(i6 * 6) + i8];
            }
            iArr9[i6] = l[i6][(iArr8[i6][c2] << 1) + iArr8[i6][5]][(iArr8[i6][1] << 3) + (iArr8[i6][2] << 2) + (iArr8[i6][3] << 1) + iArr8[i6][4]];
