...
public class g {
    ...
    private static String f996c = null;
    ...
    public static boolean g() {
        ...
        if (!a(i2) && (indexOf = i2.indexOf(" root ")) > 0) {
            ...
            if (substring.contains("x") || substring.contains(ak.aB)) {
                return true;
            }
        }
        return false;
    ...
    public static void j() {
        f.a(0, new e(TbsMediaPlayer.TbsMediaPlayerListener.MEDIA_INFO_BAD_INTERLEAVING), 15000L);
    }
