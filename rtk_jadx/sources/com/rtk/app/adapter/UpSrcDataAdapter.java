...
public class UpSrcDataAdapter extends a3 {
    ...
    private List<UpSrcDataBean.DataBean> d;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.f124c).inflate(R.layout.up_src_data_item_layout, (ViewGroup) null);
        ...
        upSrcDataHolder.upSrcDataItemDownNUM.setText(this.d.get(i).getScore());
        if (Integer.parseInt(this.d.get(i).getScore()) > 50) {
            upSrcDataHolder.upSrcDataItemDownNUM.setTextColor(this.f124c.getResources().getColor(R.color.theme2));
        } else if (Integer.parseInt(this.d.get(i).getScore()) > 100) {
            upSrcDataHolder.upSrcDataItemDownNUM.setTextColor(this.f124c.getResources().getColor(R.color.theme26));
        } else if (Integer.parseInt(this.d.get(i).getScore()) == 0) {
            upSrcDataHolder.upSrcDataItemDownNUM.setTextColor(this.f124c.getResources().getColor(R.color.theme3));
        } else {
            upSrcDataHolder.upSrcDataItemDownNUM.setTextColor(this.f124c.getResources().getColor(R.color.drak444));
        }
        return view;
    }
}
