...
public class MyPostClickDataFragment extends BaseFragment implements h.j {
    ...
    public void d(String str, int i) {
        com.rtk.app.tool.c0.u("MyPostClickDataFragment", "点击量列表" + str);
        if (i != 1) {
            return;
        }
    ...
    public void x() {
        ...
        sb.append("&page=");
        sb.append(this.r);
        sb.append("&limit=20&posts_id=");
        sb.append(this.p);
        sb.append("&range=");
        sb.append(this.q);
        sb.append("&key=");
        sb.append(com.rtk.app.tool.t.c0(com.rtk.app.tool.c0.e(com.rtk.app.tool.y.v(this.e, "posts_id=" + this.p, "uid=" + com.rtk.app.tool.y.K(), "range=" + this.q, "token=" + com.rtk.app.tool.y.H()))));
        ...
        sb3.append(sb2);
        com.rtk.app.tool.c0.u("MyPostClickDataFragment", sb3.toString());
    }

    @Override // com.rtk.app.base.BaseFragment
    protected void f() {
        this.fragmentForListviewListview.setOnLoadListener(new AutoListView.b() { // from class: com.rtk.app.adapter.r1
            @Override // com.rtk.app.custom.AutoListView.AutoListView.b
            public final void a() {
                MyPostClickDataFragment.this.x();
            }
        });
        this.fragmentForListviewListview.setOnRefreshListener(new AutoListView.c() { // from class: com.rtk.app.adapter.q1
            @Override // com.rtk.app.custom.AutoListView.AutoListView.c
            public final void onRefresh() {
                MyPostClickDataFragment.this.z();
            }
        });
    }
    ...
    public void g(int i, String str, int i2) {
        ...
        if (this.r == 1) {
            t(str, new com.rtk.app.tool.s() { // from class: com.rtk.app.adapter.s1
                @Override // com.rtk.app.tool.s
                public final void a(String[] strArr) {
                    MyPostClickDataFragment.this.v(strArr);
                }
            });
        }
    }
    ...
    protected void i() {
        ...
        this.p = arguments.getString("sid");
