...
public class OtherUpApkCommentAdapter extends a3 {

    /* renamed from: c, reason: collision with root package name */
    private Context f98c;
    ...
    public OtherUpApkCommentAdapter(Context context, List<MyUpApkCommentBean.DataBean> list, String str) {
        super(list);
        this.f98c = context;
        this.d = list;
        this.e = str;
    ...
    */
    public android.view.View getView(int r7, android.view.View r8, android.view.ViewGroup r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.rtk.app.adapter.OtherUpApkCommentAdapter.getView(int, android.view.View, android.view.ViewGroup):android.view.View");
    }
}
