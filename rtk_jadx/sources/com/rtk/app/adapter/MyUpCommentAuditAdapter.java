...
public class MyUpCommentAuditAdapter extends a3 implements h.j {
    ...
    public MyUpCommentAuditAdapter(Context context, List<UpApkCommentAuditBean.DataDTO> list) {
        super(list);
        this.f92c = context;
        this.d = list;
    }
    ...
    private void e(FlowLayout flowLayout, final List<String> list) {
        ...
        for (final int i = 0; i < list.size(); i++) {
            View inflate = LayoutInflater.from(this.f92c).inflate(R.layout.just_image_view_layout, (ViewGroup) flowLayout, false);
            ImageView imageView = (ImageView) inflate.findViewById(R.id.just_imageView);
            flowLayout.addView(inflate);
            com.rtk.app.tool.t.c(this.f92c, list.get(i), imageView, new boolean[0]);
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rtk.app.adapter.t1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    MyUpCommentAuditAdapter.this.j(list, i, view);
                }
            });
        }
    }
    ...
    private void f(int i, int i2, String str) {
        ...
        sb.append(com.rtk.app.tool.y.u(this.f92c));
        sb.append("&uid=");
        ...
        sb.append(str);
        sb.append("&key=");
        sb.append(com.rtk.app.tool.t.c0(com.rtk.app.tool.c0.e(com.rtk.app.tool.y.v(this.f92c, "uid=" + com.rtk.app.tool.y.K(), "token=" + com.rtk.app.tool.y.H(), "cid=" + dataDTO.getId(), "state=" + i))));
        com.rtk.app.tool.o.h.l(this.f92c, this, i2, com.rtk.app.tool.o.h.h(com.rtk.app.tool.y.e).a(sb.toString()));
    }

    private void h(ViewHolder viewHolder, final int i) {
        viewHolder.upCommentAuditListItemIcon.setOnClickListener(new View.OnClickListener() { // from class: com.rtk.app.adapter.v1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MyUpCommentAuditAdapter.this.l(i, view);
            }
        });
        viewHolder.upCommentAuditListItemNoPassBtu.setOnClickListener(new View.OnClickListener() { // from class: com.rtk.app.adapter.u1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MyUpCommentAuditAdapter.this.n(i, view);
            }
        });
        viewHolder.upCommentAuditListItemDeleteBtu.setOnClickListener(new View.OnClickListener() { // from class: com.rtk.app.adapter.a2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MyUpCommentAuditAdapter.this.p(i, view);
            }
        });
        viewHolder.upCommentAuditListItemPassBtu.setOnClickListener(new View.OnClickListener() { // from class: com.rtk.app.adapter.z1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MyUpCommentAuditAdapter.this.r(i, view);
            }
        });
        viewHolder.upCommentAuditListItemAuditCheckUserLv.setOnClickListener(new View.OnClickListener() { // from class: com.rtk.app.adapter.w1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MyUpCommentAuditAdapter.this.t(i, view);
            }
        });
    }
    ...
    public /* synthetic */ void j(List list, int i, View view) {
        com.rtk.app.tool.t.C0(this.f92c, list, i);
    }
    ...
    public /* synthetic */ void l(int i, View view) {
        ...
        com.rtk.app.tool.t.B0(this.f92c, dataDTO.getUser().getId() + "");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: m, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void n(final int i, View view) {
        new DialogForAuditCheckReason(this.f92c, R.array.audit_reason_bbs_comment, new com.rtk.app.tool.s() { // from class: com.rtk.app.adapter.x1
            @Override // com.rtk.app.tool.s
            public final void a(String[] strArr) {
                MyUpCommentAuditAdapter.this.v(i, strArr);
            }
        }).show();
    }
    ...
    public /* synthetic */ void p(final int i, View view) {
        new DialogForAuditCheckReason(this.f92c, R.array.audit_reason_bbs_comment, new com.rtk.app.tool.s() { // from class: com.rtk.app.adapter.y1
            @Override // com.rtk.app.tool.s
            public final void a(String[] strArr) {
                MyUpCommentAuditAdapter.this.x(i, strArr);
            }
        }).show();
    }
    ...
    public /* synthetic */ void t(int i, View view) {
        if (this.d.get(i).getCheck_user() != null) {
            com.rtk.app.tool.t.B0(this.f92c, this.d.get(i).getCheck_user().getCheck_uid());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: u, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void v(int i, String[] strArr) {
        f(2, i, strArr[0]);
    }
    ...
    public void d(String str, int i) {
        ...
        com.rtk.app.tool.c0.u("MyUpCommentAuditAdapter", "up评论审核返回:" + str);
    ...
    public void g(int i, String str, int i2) {
        com.rtk.app.tool.f.a(this.f92c, str, f.a.f);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.f92c).inflate(R.layout.up_comment_audit_list_item_layout, (ViewGroup) null);
        ...
        UpApkCommentAuditBean.DataDTO dataDTO = this.d.get(i);
        com.rtk.app.tool.t.c(this.f92c, dataDTO.getUser().getFace(), viewHolder.upCommentAuditListItemIcon, new boolean[0]);
        ...
        c.d.a.d.f(this.f92c, viewHolder.upCommentAuditListItemState, parseInt);
        ...
        if (dataDTO.getCheck_user() != null && !com.rtk.app.tool.c0.q(dataDTO.getCheck_user().getCheck_nickname())) {
            com.rtk.app.tool.t.c(this.f92c, dataDTO.getCheck_user().getCheck_face(), viewHolder.upCommentAuditListItemAuditCheckUserIcon, new boolean[0]);
