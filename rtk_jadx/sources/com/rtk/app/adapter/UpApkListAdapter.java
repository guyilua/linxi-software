...
public class UpApkListAdapter extends a3 {

    /* renamed from: c, reason: collision with root package name */
    private Context f114c;
    ...
    class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            com.rtk.app.tool.i.i.o(UpApkListAdapter.this.f114c, this.a, (TextView) view);
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        String str;
        if (view == null) {
            view = LayoutInflater.from(this.f114c).inflate(R.layout.up_apk_list_item_layout, (ViewGroup) null);
        ...
        viewHolder.upApkListItemGameVersionAndSize.setText(this.d.get(i).getVersionName() + "  |  " + str);
        com.rtk.app.tool.t.c(this.f114c, this.d.get(i).getSourceLogo(), viewHolder.upApkListItemIcon, new boolean[0]);
        ApkInfo apkInfo = new ApkInfo(this.d.get(i));
        apkInfo.setNeedCoin(this.d.get(i).getNeedCoin());
        ...
        com.rtk.app.tool.i.i.p(this.f114c, apkInfo, viewHolder.upApkListItemDownload, viewHolder.upApkListItemProgressBar);
