...
public class UpCheckApkListActivity extends BaseActivity {
    ...
    protected void A() {
        com.rtk.app.tool.t.S1(this.f147c, this.upCheckApkListTopLayout, this.upCheckApkListTabLayout, null, ((ViewGroup) findViewById(R.id.content)).getChildAt(0));
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case com.rtk.app.R.id.up_check_apk_list_top_download /* 2131300758 */:
                ...
                return;
            case com.rtk.app.R.id.up_check_apk_list_top_layout /* 2131300759 */:
            default:
                return;
