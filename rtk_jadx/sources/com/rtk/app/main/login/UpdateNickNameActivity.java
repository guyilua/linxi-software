...
public class UpdateNickNameActivity extends BaseActivity implements h.j {
    private LinearLayout q;
    private String r;
    private CustomSingleEditTextView s;
    ...
    public void L(int... iArr) {
        ...
        hashMap.put("key", t.c0(c0.e(y.v(this.f147c, "uid=" + y.K(), "token=" + y.H(), "nickname=" + this.r))));
        AppCompatActivity appCompatActivity2 = this.f147c;
        StringBuilder sb = new StringBuilder();
        sb.append(y.e);
        sb.append("user/info/nickname");
        com.rtk.app.tool.o.h.j(appCompatActivity2, this, sb.toString(), 1, hashMap);
    }

    @Override // com.rtk.app.tool.o.h.j
    public void d(String str, int i) {
        c0.u("UpdateNickNameActivity", "修改昵称成功:" + str);
        com.rtk.app.tool.f.a(this.f147c, "修改昵称成功", f.a.f);
        finish();
    }

    @Override // com.rtk.app.tool.o.h.j
    public void g(int i, String str, int i2) {
        c0.s("UpdateNickNameActivity", "修改昵称失败:" + str);
        com.rtk.app.tool.f.a(this.f147c, "修改昵称失败:" + str, f.a.f);
    }
    ...
    public void initView() {
        this.q = (LinearLayout) findViewById(R.id.update_nickname_top_layout);
        CustomSingleEditTextView customSingleEditTextView = (CustomSingleEditTextView) findViewById(R.id.custom_single_edit_text);
        this.s = customSingleEditTextView;
        customSingleEditTextView.setMaxWordCount(10);
        this.s.setHint("请输入昵称");
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.update_nickname_save /* 2131301109 */:
                ...
                this.r = replaceAll;
                if (!c0.q(replaceAll) && this.r.length() >= 2 && this.r.length() <= 10) {
                    new x(this.f147c, "确定修改昵称", "您的昵称将设置为:“" + this.r + "”。确定后一周内不可更改。", new s() { // from class: com.rtk.app.main.login.j
                        @Override // com.rtk.app.tool.s
                        public final void a(String[] strArr) {
                            UpdateNickNameActivity.this.N(strArr);
                        }
                    }).show();
                    return;
                }
