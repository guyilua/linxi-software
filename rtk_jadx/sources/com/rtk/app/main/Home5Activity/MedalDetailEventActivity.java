...
public class MedalDetailEventActivity extends AppCompatActivity implements View.OnClickListener, com.rtk.app.base.f, h.j {
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (MedalDetailEventActivity.this.f186c.equals(MedalDetailEventActivity.this.e.getData().get(intValue).getId())) {
    ...
    private void s(String str, String str2, int i, int i2) {
        ...
        if (!com.rtk.app.tool.c0.q(this.f186c) && !this.f186c.equals(str)) {
    ...
    public void initData() {
        ...
        this.f186c = extras.getString("gid", "");
    ...
    public void t(int... iArr) {
        ...
        if (iArr[0] != 1) {
            ...
            str = "members/medaldetail" + com.rtk.app.tool.y.u(this.f) + "&uid=" + this.d + "&gid=" + this.f186c + "&table=eventMedal&key=" + com.rtk.app.tool.t.c0(com.rtk.app.tool.c0.e(com.rtk.app.tool.y.v(this.f, new String[0])));
        }
        com.rtk.app.tool.o.h.l(this.f, this, 1, com.rtk.app.tool.o.h.h(new String[0]).a(str));
        com.rtk.app.tool.c0.u("MedalDetailEventActivity", "勋章详情链接  " + com.rtk.app.tool.y.d + str);
    }

    public void u(int i) {
        LinearLayout.LayoutParams layoutParams;
        for (int i2 = 0; i2 < this.medalDetaiEventMedalFlow.getChildCount(); i2++) {
            if (i2 == i) {
                layoutParams = new LinearLayout.LayoutParams(135, 135);
            } else {
                layoutParams = new LinearLayout.LayoutParams(100, 100);
            }
            this.medalDetaiEventMedalFlow.getChildAt(i2).setLayoutParams(layoutParams);
        }
    }
}
