...
public class Home5MyLevelFragment1 extends BaseFragment implements h.j {
    View o;
    Unbinder p;
    ...
    public void d(String str, int i) {
        com.rtk.app.tool.c0.u("Home5MyLevelFragment1", "我的等级   ----   经验值规则" + str);
        if (i != 1) {
            return;
        }
    ...
    /* renamed from: e */
    protected void C() {
        com.rtk.app.tool.o.h.l(this.e, this, 1, com.rtk.app.tool.o.h.h(new String[0]).a("members/coinRules" + com.rtk.app.tool.y.u(this.e) + "&rid=1&key=" + com.rtk.app.tool.t.c0(com.rtk.app.tool.c0.e(com.rtk.app.tool.y.v(this.e, "rid=1")))));
    }
