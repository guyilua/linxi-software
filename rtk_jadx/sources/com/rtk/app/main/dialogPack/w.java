...
/* compiled from: DialogForUpShowReason.java */
...
public class w extends o {
    ...
    public w(Context context, int i, com.rtk.app.tool.s sVar) {
        super(context);
        this.k = sVar;
    ...
    public void p() {
        this.l.setOnTagClickListener(new TagFlowLayout.b() { // from class: com.rtk.app.main.dialogPack.h
            public final boolean a(View view, int i, FlowLayout flowLayout) {
                return w.this.r(view, i, flowLayout);
            }
        });
    }
}
