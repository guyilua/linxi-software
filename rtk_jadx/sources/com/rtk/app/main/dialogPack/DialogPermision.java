...
public class DialogPermision extends Dialog implements View.OnClickListener {
    public static String e;
    private Window a;
    private ViewHolder b;

    /* renamed from: c, reason: collision with root package name */
    private Context f243c;
    private boolean d;
    ...
    public class ViewHolder {
        ...
        ViewHolder(DialogPermision dialogPermision, View view) {
    ...
    public DialogPermision(@NonNull Context context, String str) {
        super(context);
        this.d = false;
        this.f243c = context;
        e = str;
            ...
            case R.id.dialog_permission_ensure /* 2131297326 */:
                try {
                    ...
                    if (i >= 9) {
                        ...
                        intent.setData(Uri.fromParts("package", this.f243c.getPackageName(), null));
                    } else if (i <= 8) {
                        intent.setAction("android.intent.action.VIEW");
                        intent.setClassName("com.android.settings", "com.android.settings.InstalledAppDetails");
                        intent.putExtra("com.android.settings.ApplicationPkgName", this.f243c.getPackageName());
                    }
                    this.f243c.startActivity(intent);
                    ((Activity) this.f243c).startActivityForResult(intent, TbsLog.TBSLOG_CODE_SDK_INIT);
                } catch (Exception e2) {
                    com.rtk.app.tool.f.a(this.f243c, "跳转失败", f.a.f);
                    e2.printStackTrace();
                }
                dismiss();
                return;
