...
public class MyFamilyPostFragment extends BaseFragment implements h.j {
    ...
    /* renamed from: e */
    protected void z() {
        if (!com.rtk.app.tool.y.x(this.e) || TextUtils.isEmpty(this.u) || TextUtils.isEmpty(this.t)) {
            return;
        }
        ...
        com.rtk.app.tool.c0.u("MyFamilyPostFragment", "  社区地址    " + com.rtk.app.tool.y.e + w);
