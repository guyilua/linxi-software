...
public class FamilyUpCommentAuditListActivity extends BaseActivity implements h.j {
    private Bundle q;
    private UpFamilyCommentAuditFragment s;
    ...
    class a implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int i) {
            FamilyUpCommentAuditListActivity familyUpCommentAuditListActivity = FamilyUpCommentAuditListActivity.this;
            familyUpCommentAuditListActivity.s = (UpFamilyCommentAuditFragment) familyUpCommentAuditListActivity.r.get(i);
        }
    }

    @Override // com.rtk.app.base.BaseActivity
    protected void A() {
        t.S1(this.f147c, this.upCommentAuditListLayout, this.upCommentAuditListTabLayout, null, ((ViewGroup) findViewById(R.id.content)).getChildAt(0));
    }
    ...
    public void initView() {
        ...
        for (int i = 1; i <= 4; i++) {
            UpFamilyCommentAuditFragment upFamilyCommentAuditFragment = new UpFamilyCommentAuditFragment();
            Bundle bundle = new Bundle();
            bundle.putInt("state", i);
            bundle.putString("family_id", this.w);
            bundle.putInt("hasCommentPermission", this.v);
            upFamilyCommentAuditFragment.setArguments(bundle);
            this.r.add(upFamilyCommentAuditFragment);
        }
        this.s = (UpFamilyCommentAuditFragment) this.r.get(0);
        this.t.add("待审核");
        this.t.add("审核不通过");
        this.t.add("审核通过");
        this.t.add("已删除");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case com.rtk.app.R.id.help /* 2131297862 */:
                Bundle bundle = new Bundle();
                bundle.putString("title", "家族UP评论审核功能帮助");
                bundle.putString("url", "user/agreement/family/up-comment-check-help");
                com.rtk.app.tool.c.b(this, FamilyProtocolActivity.class, bundle);
                return;
            case com.rtk.app.R.id.up_family_comment_audit_list_back /* 2131300881 */:
                finish();
                return;
            case com.rtk.app.R.id.up_family_comment_audit_list_refresh /* 2131300883 */:
                this.s.u();
                return;
            case com.rtk.app.R.id.up_family_comment_audit_my_audit /* 2131300886 */:
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(com.rtk.app.R.layout.activity_up_family_comment_audit_list);
        ButterKnife.a(this);
    }
}
